        ...
        <>
            <View style={{ height: "100%", zIndex :0 }}>
                <ScrollView style={{ height: "100%" }}>
                    <Container style={{ height: "100%", bgcolor: "#222121", padding: 2 }}>
                        <Image source={require("../assets/H.png")} style={{ height: 200, width: "100%" }}></Image>
                    </Container>
                    <Container style={{ position: "absolute", top: "97%", left: 0, right: 0, height: containerHeight -200, bgcolor: "white", padding: 2, borderTopLeftRadius: 10, borderTopRightRadius: 10 }}>
                    <TextField
                            id="email"
                            label="Email"
                            color={"warning"}
                        ...
                        <Divider><Typography style={{ fontFamily: "Poppins_400Regular", fontSize: 16 }}>Or create one</Typography></Divider>
